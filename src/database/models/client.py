...
class Client(Base):
    ...
    alert_time_range_start = Column(types.DateTime(timezone=True), nullable=True)
    alert_time_range_end = Column(types.DateTime(timezone=True), nullable=True)
...
class ClientSchema(Schema):  # type: ignore
    ...
    alert_time_range_start = fields.DateTime()
    alert_time_range_end = fields.DateTime()
